                        ...
                        <td>
                            <div class="d-flex gap-2 my-1  justify-content-center align-items-center">
                                ...
                                <span class="delete-btn" data-bs-toggle="modal"
                                    data-bs-target="#alessio{{ $project->id }}">
...
@section('modals')
    <section class="container my-5">
        ...
        <!-- Modal -->
        @foreach ($projects as $project)
            <div class="modal fade" id="alessio{{ $project->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="exampleModalLabel"> Cancel {{ $project->name }}</h1>
